document.addEventListener('DOMContentLoaded', function() {
    ...
    const btnRegistrarIntercambio = document.querySelector(".botonRegistroIntercambio");
    const popRegistroIntercambio = document.getElementById("registroIntercambio");
    const overlay = document.createElement('div');
    overlay.classList.add('overlay');
    document.body.appendChild(overlay);

    // Abrir modal (versión mejorada de tu código)
    btnRegistrarIntercambio.onclick = function() {
        popRegistroIntercambio.classList.add("active");
    ...
    overlay.addEventListener('click', function() {
        popRegistroIntercambio.classList.remove("active");
